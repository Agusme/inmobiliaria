         ...
         <div id="compra">
            ...
            <Container fluid className="bg-white py-5 mb-5">
                ...
                <Row className="text-center">
                    <Col lg={3} md={3} sm={12}>  <Card className="bg-imageCasa bg-img p-5 mb-2">
                 <p className="text-white fw-semibold fs-5">Casa</p>
                </Card></Col>
                <Col lg={3} md={3} sm={12}>  <Card className="bg-imageCard3 bg-img p-5 mb-2">
                 <p className="text-white fw-semibold fs-5">Departamento</p>
                </Card></Col>
                <Col lg={3} md={3} sm={12}>  <Card className="bg-imageCard1 bg-img p-5 mb-2">
                 <p className="text-white fw-semibold fs-5">Terreno</p>
                </Card></Col>
                <Col lg={3} md={3} sm={12}>  <Card className="bg-imageCard2 bg-img p-5 mb-2">
