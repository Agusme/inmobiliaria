...
const DptoAlquiler = ({ properties }) => {
  return (
    <div className="pt-5 bg-white pb-5">
      <Container className="py-3 letra-azul">
        <h1 className="letra-azul mb-3 pt-5 text-center display-4">
              ...
              (property) =>
                ...
                property.typeProperty === "Departamento" && (
                  <Col key={property._id} lg={3} md={3} sm={6} className="my-3">
                    <Link
                      to={`/alquiler-dpto-id/${property._id}`}
                      className="text-decoration-none"
                    >
                      <Card className=" d-flex flex-column text-center card-houses border-0 rounded">
                        <img
